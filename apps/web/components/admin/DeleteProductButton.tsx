...
import { deleteProduct } from '@/lib/api'; // Вкажи свій шлях
...
export default function DeleteProductButton({ id }: { id: string }) {
  ...
  return (
    <button 
      ...
      disabled={isDeleting}
      title="Видалити"
      className="p-2.5 text-white/40 hover:text-red-400 bg-white/5 hover:bg-red-500/10 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
    >
      {isDeleting ? (
